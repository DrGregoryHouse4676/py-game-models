    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('race', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='players', to='db.race')),
                ('skills', models.ManyToManyField(blank=True, to='db.skill')),
            ],
        ),
    ]
